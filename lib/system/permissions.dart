...
enum MindPermission {
  ...
  /// แอปโทรศัพท์หลักของเครื่อง
  ///
  /// 🔴 **เป็นแล้วทุกสายของเครื่องผ่านแอปนี้** สายเข้า สายออก สายซ้อน
  /// ไม่ใช่แค่สายที่เธอสนใจ · เป็นสิทธิ์เดียวในรายการนี้ที่**เปลี่ยนวิธี
  /// ใช้โทรศัพท์ทั้งเครื่อง** ไม่ใช่แค่เปิดความสามารถของแอป
  ///
  /// ให้แล้วได้: จอสายเป็นของเราเอง (ที่เดียวที่เธอโผล่มาตอนมีสายได้)
  /// รับ/วาง/ปิดไมค์/สลับลำโพงได้จริง
  ///
  /// **ยังไม่ได้:** ป้อนเสียงเธอเข้าไปในสาย — Android ไม่มี API ให้ทำ
  /// ไม่ว่าจะเป็นแอปหลักหรือไม่ · ทางเดียวคือเปิดลำโพงให้ไมค์รับเสียงเธอ
  defaultDialer(
